...
LOGFILE=${LOGPATH}rscat_knmi.netcdf.rapidscat.log
...
SCRIPTBEGINS=___The_Script_-rscat_knmi_process_ncdf.ksh-__BEGINS_at_
SCRIPTENDS=___The_Script_-rscat_knmi_process_ncdf.ksh-__ENDED_at_
