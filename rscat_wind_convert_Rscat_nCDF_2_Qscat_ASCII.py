...
#
#  PROGRAM OVERVIEW:
#  	(1) This program reads in the RAPIDSCAT data from NASA Jet Propoulsion Lab (JPL).
#	(2) The input file is in netCDF4 format. 
#	(3) The output file is an ASCII file in column format.
#	(4) There are two functions, -Print_Current_Time(now)- and -Get_Converted_Time(spacecrafttime)-
#		-a- -Print_Current_Time- simply prints the current time.
#		-b- --Get_Converted_Time- reads in the time from the netCDF4 file in megaseconds
#		    (such as 500000000 seconds) since January 1st, 1999, at 0000UTC, then 
...
#  - - - - - -  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#  Version 2.4.3A, Dated 2015-Nov-26
#                  Modified to use more of the standard system variables.
#  - - - - - -  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#  Version 2.4.3B, Dated 2016-Jan-11
#                  Modified to fix subdirectories
#
#  - - - - - -  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#  Version 2.4.3C, Dated 2016-Jan-15
...
#------------------------------------------------------------------------------------------
#  PYTHON MODULES USED: 
#  numpy (as N), scipy (as S), matplotlib (as M), netCDF4 (as NCF), datetime, os (as OS),
#  sys (as SYS), math (as MATH), warnings (as WARNINGS), socket, and -commands-.
#------------------------------------------------------------------------------------------
#
...
#       --> now:String, Output: Formatted String
#  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .  .
#  ==> Get_Converted_Time(spacecrafttime):
...
#-----#-----#-----#-----#-----#-----#-----#-----#-----#-----#-----
#######  Begin Function Get_Converted_Time
#-----#-----#-----#-----#-----#-----#-----#-----#-----#-----#-----
#
def Get_Converted_Time(spacecrafttime):
    #
    # The input variable -spacecrafttime- must be provided in seconds 
    # since January 1st, 1999:Time 0000UTC
    ...
    # NOTE CAREFULLY!!!!! 
    # =====================
    # THIS FUNCTION WORKS FOR NASA RAPIDSCAT AND NASA RAPIDSCAT ONLY!!!!!
    # --------------------------------------------------------------------
    # The basis time for RapidScat is currently a one-of-a-kind -19990101-0000.00.000-UTC--. 
    # No other active satellites use this basis time as far as we know!
    # Unless you KNOW that your satellite uses the 1999 basis time shown above, 
    ...
    # - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    #
    FR_start_13 = (10.0*sec_per_yr) + (4 * sec_pr_lyr)
    # answer should be 441849600.0 sec
    ...
    if yesnoleapyear == 1:                                         ###---===---
        ...
        print(dadots+dadots)                                       ###---===---
        this_month_n_date=Determine_mndate_from_leapjday(num_days) ###---===---
    else:                                                          ###---===---
    ...
    #
    #-----#-----#-----#-----#-----#-----#-----#-----#-----#-----#-----
    #### END OF Get_Converted_Time FUNCTION
    #-----#-----#-----#-----#-----#-----#-----#-----#-----#-----#-----
#
#xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
#xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
...
def main():
    ...
    #
    print(dadots)
    print('---BEGIN rscat_wind_convert_Rscat_nCDF_2_Qscat_ASCII.py ------V2.4.3B  -----')
    ...
    #-----------------
    if my_XFER_BASEPATH== '':
        my_XFER_BASEPATH='/satdat/curr/rscat_wind'
        #
    #----------------------------------------------------------------
    #
    ...
    #
    infromlinux = commands.getoutput('echo ${NRT_BASEPATH}')     ### NRT_BASEPATH=$RSCAT_BASEPATH/nrt
    #                                                            ### NRT_BASEPATH=/satdat/curr/RapidScat/nrt
    #
    #
    my_KNMI_BASEPATH=infromlinux
    my_NRT_BASEPATH=infromlinux
    #
    #-----------------
    if my_KNMI_BASEPATH== '':
        my_KNMI_BASEPATH='/satdat/curr/RapidScat/nrt'
        #
    #----------------------------------------------------------------
    #-----------------
    if my_NRT_BASEPATH== '':
        my_NRT_BASEPATH='/satdat/curr/RapidScat/nrt'
        #
    #----------------------------------------------------------------
    #
    #
    ...
    #
    #
    #graphicpath='/satdat/'+system_design8r+'/RapidScat/nrt/graphic/'
    #
    #ascii_path='/satdat/'+system_design8r+'/RapidScat/nrt/ascii/'
    #ascii_path_orig='/satdat/'+system_design8r+'/RapidScat/nrt/ascii/'
    #ascii_path_temp='/satdat/'+system_design8r+'/RapidScat/nrt/ascii_temp/'
    #
    #
    #----------------------------------------------------------------
    if thehost == "a4bu":
    ...
    #
    #
    ascii_path_isis='/satdat/'+system_design8r+'/RapidScat/nrt/ascii_2_isis/'
    ascii_path_isis=my_KNMI_BASEPATH+'/ascii_2_isis/'
    #
    ascii_path=ascii_path_temp
    #
    ascii_path_one='/satdat/m4b/RapidScat/nrt/ascii/'
    #
    #.....................................................................--------------------
    ...
    utilpath='/satdat/'+system_design8r+'/RapidScat/nrt/Nutil/'
    utilpath=my_KNMI_BASEPATH+'/Nutil/'
    #
    #
    #procpath=binpath+'processed/'
    procpath='/satdat/'+system_design8r+'/RapidScat/nrt/Nprocessed/'
    ...
    if valid_util_path:
        print(dadash)
        print("The datapath for -utilpath- is: "+utilpath)
    ...
    if valid_bin_path:
        print(dadash)
        print("The datapath for -binpath- is: "+binpath)
        print("The datapath is VALID and EXISTS")
        print(dadash)
        #
    else:
        ...
        print("The datapath for -binpath- is currently set to: "+binpath)
        print("-------The binpath is INVALID! NEED TO CHECK THIS!!!!!!!! -----------------")
        return this_execution
        #-----------------------------------------------------------
        # End of if block
    ...
    #.....................
    #
    # Check ascii_path_one
    #
    valid_ascii_path_one=OS.path.exists(ascii_path_one)

    if valid_ascii_path_one:
        print(dadash)
        print("The ascii_path_one is: "+ascii_path_one)
        print("The ascii_path_one is VALID and EXISTS")
        print(dadash)
        #
    else:
        #
        this_execution=90
        print("-------The ascii_path_one is INVALID! NEED TO CHECK THIS!!!!!!!! -----------------")
        return this_execution
        #-----------------------------------------------------------
        # End of if block
        #-----------------------------------------------------------
    ...
    the_ncdf_files=OS.system('ls -1 '+datapath+'rs_l2b_v1*.nc > '+templist_of_ncdf_files)
    ...
    print("Datarain_impact Shape")
    print(N.shape(datarain_impact))
    print(dadots)
    print(dadots)
    #
    dataflags = fileobj.variables['flags'][:]
    print("Dataflags Shape")
    print(N.shape(dataflags))
    print(dadots)
    print(dadots)
    #
    dataeflags = fileobj.variables['eflags'][:]
    print("Dataeflags Shape")
    print(N.shape(dataeflags))
    print(dadots)
    print(dadots)
    #
    data_ndg_wndspd = fileobj.variables['nudge_wind_speed'][:]
    print("Data_ndg_wndspd Shape")
    print(N.shape(data_ndg_wndspd))
    print(dadots)
    print(dadots)
    #
    data_ndg_wnddir = fileobj.variables['nudge_wind_direction'][:]
    print("Data_ndg_wnddir Shape")
    print(N.shape(data_ndg_wnddir))
    print(dadots)
    print(dadots)
    #
    data_rtr_wspd_uncor = fileobj.variables['retrieved_wind_speed_uncorrected'][:]
    print("Data_rtr_wspd_uncor Shape")
    print(N.shape(data_rtr_wspd_uncor))
    print(dadots)
    print(dadots)
    #
    data_xtrk_wspd_bias = fileobj.variables['cross_track_wind_speed_bias'][:]
    print("Data_xtrk_wspd_bias Shape")
    print(N.shape(data_xtrk_wspd_bias))
    print(dadots)
    print(dadots)
    #
    data_atm_spd_bias = fileobj.variables['atmospheric_speed_bias'][:]
    print("Data_atm_spd_bias Shape")
    print(N.shape(data_atm_spd_bias))
    print(dadots)
    print(dadots)
    #
    data_num_ambig = fileobj.variables['num_ambiguities'][:]
    print("Data_num_ambig Shape")
    print(N.shape(data_num_ambig))
    print(dadots)
    print(dadots)
    #
    data_wind_obj = fileobj.variables['wind_obj'][:]
    print("Data_wind_obj Shape")
    print(N.shape(data_wind_obj))
    print(dadots)
    print(dadots)
    #
    data_ambig_spd = fileobj.variables['ambiguity_speed'][:]
    print("Data_ambig_spd Shape")
    print(N.shape(data_ambig_spd))
    print(dadots)
    print(dadots)
    #
    data_ambig_dir = fileobj.variables['ambiguity_direction'][:]
    print("Data_ambig_dir Shape")
    print(N.shape(data_ambig_dir))
    print(dadots)
    print(dadots)
    #
    data_ambig_obj = fileobj.variables['ambiguity_obj'][:]
    print("Data_ambig_obj Shape")
    print(N.shape(data_ambig_obj))
    print(dadots)
    print(dadots)
    #
    data_num_infore = fileobj.variables['number_in_fore'][:]
    print("Data_num_infore Shape")
    print(N.shape(data_num_infore))
    print(dadots)
    print(dadots)
    #
    data_num_inaft = fileobj.variables['number_in_aft'][:]
    print("Data_num_inaft Shape")
    print(N.shape(data_num_inaft))
    print(dadots)
    print(dadots)
    #
    data_num_outfore = fileobj.variables['number_out_fore'][:]
    print("Data_num_outfore Shape")
    print(N.shape(data_num_outfore))
    print(dadots)
    print(dadots)
    #
    data_num_outaft = fileobj.variables['number_out_aft'][:]
    print("Data_num_outaft Shape")
    print(N.shape(data_num_outaft))
    print(dadots)
    print(dadots)
    #
    #-------------------------------------------------------------
    ...
    ascii_file_name_a = asciifilenamea+".ascii.txt"
    ...
    for i in xrange(shape_wspd[0]):
        for j in xrange(shape_wspd[1]):
            #
            STR_TIME=str(datatim[i])
            STR_ORIG_TIME=str(datatim[i])
            ORIG_TIME=datatim[i]
            #
            STR_TIME_INPUT=FACTOR48+datatim[i]
            #
	    ...
	    STR_NCEP_WSPD=Determine_Wind_SPEED(data_NCEP_netcdf)
            ...
            #
            #------------------------------------
            STR_ND_WDIR=str(data_ndg_wnddir[i,j])
            STR_NCEP_WDIR_A=data_ndg_wnddir[i,j]
            STR_NCEP_WDIR_B=str(data_ndg_wnddir[i,j])
	    ...
	    #
            #
            STRTESTLINE1='[]'+str(STR_AMBIG_OBJ0_A)+'[-[RwABG_OJ0]-]'+'[]'+str(STR_AMBIG_OBJ1_A)+'[-[RwABG_OJ1]-]'
            STRTESTLINE2='[]'+str(STR_AMBIG_OBJ2_A)+'[-[RwABG_OJ2]-]'+'[]'+str(STR_AMBIG_OBJ3_A)+'[-[RwABG_OJ3]-]'
            STRTESTLINE3=STRTESTLINE1+STRTESTLINE2
            #
            #
            #--#--#--#--#--#--#--#--#--#--#--#--#--#--#--#--#--#--#--#--#
            #
    ...
    #---===---===---
    #
    copy_the_ascii_files=OS.system('cp '+ascii_file_name+' '+ascii_path_one)
    print("---Copying  to the location....."+ascii_path_one)
    #
    #---===---===---
    #
    if copy_the_ascii_files==0:
        #
        print("---SUCCESSFUL Copy to the location....."+ascii_path_one)
        #
    else:
        print("---FAILURE! Copy of ascii file did not occur to the location....."+ascii_path_one)
        this_execution=97
        #
        #----------------------------------------------------------------
        #END IF
...
###.  .  .  .  .  .  .  .  .  .  .  .  .
###Title
###Rapidscat Level 2B Ocean Wind Vectors in 12.5km Slice Composites
###.  .  .  .  .  .  .  .  .  .  .  .  .
###Dimensions
### OrderedDict([(u'along_track', <netCDF4.Dimension object at 0xe60e60>), 
###              (u'cross_track', <netCDF4.Dimension object at 0xe60dd0>), 
###              (u'ambiguities', <netCDF4.Dimension object at 0xe55050>)])
###.  .  .  .  .  .  .  .  .  .  .  .  .
###Variables
### OrderedDict([(u'time', <netCDF4.Variable object at 0xe497d0>), 
###              (u'lat', <netCDF4.Variable object at 0xe49850>), 
###              (u'lon', <netCDF4.Variable object at 0xe498d0>), 
###              (u'retrieved_wind_speed', <netCDF4.Variable object at 0xe49950>), 
###              (u'retrieved_wind_direction', <netCDF4.Variable object at 0xe499d0>), 
###              (u'rain_impact', <netCDF4.Variable object at 0xe49a50>), 
###              (u'flags', <netCDF4.Variable object at 0xe49ad0>), 
###              (u'eflags', <netCDF4.Variable object at 0xe49b50>), 
###              (u'nudge_wind_speed', <netCDF4.Variable object at 0xe49bd0>), 
###		 (u'nudge_wind_direction', <netCDF4.Variable object at 0xe49c50>), 
###		 (u'retrieved_wind_speed_uncorrected', <netCDF4.Variable object at 0xe49cd0>), 
###		 (u'cross_track_wind_speed_bias', <netCDF4.Variable object at 0xe49d50>), 
###		 (u'atmospheric_speed_bias', <netCDF4.Variable object at 0xe49dd0>), 
###		 (u'num_ambiguities', <netCDF4.Variable object at 0xe49e50>), 
###		 (u'wind_obj', <netCDF4.Variable object at 0xe49ed0>), 
###		 (u'ambiguity_speed', <netCDF4.Variable object at 0xe49f50>), 
###		 (u'ambiguity_direction', <netCDF4.Variable object at 0xe6c050>), 
###		 (u'ambiguity_obj', <netCDF4.Variable object at 0xe6c0d0>), 
###		 (u'number_in_fore', <netCDF4.Variable object at 0xe6c150>), 
###		 (u'number_in_aft', <netCDF4.Variable object at 0xe6c1d0>), 
###		 (u'number_out_fore', <netCDF4.Variable object at 0xe6c250>), 
###		 (u'number_out_aft', <netCDF4.Variable object at 0xe6c2d0>)])
###		 
######################################################################################################
###
###
