...
#
#  NAME: rscat_knmi_adjust_satfocus_data.pl
#  
#        A.K.A: Adjust_RapidScat_ASCII_Data_files_for_SATFOCUS.pl
#
...
#-
#
# Programmer: Mr. Paul McCrone      15 April 2016
#
#==============================================================================
...
print "\n\n -------------------------------------------------------\n";
print " START PERL SCRIPT: -rscat_knmi_adjust_satfocus_data.pl-  \n";
print " -----------------------------------------------------------\n";
...
foreach $oneline (@datafile_lines) {
	...
	#
        ...
        #$testddd99=index($oneline,$dashdashdash99);
        $testddd99=index($oneline,$underscore);
	#
	if ($testddd99 != -1) {
	           #substr($oneline,$testddd99,5)=$space2dash99;
	           substr($oneline,$testddd99,1)=$blankspace;
	}
	#
        # START i loop -1-
...
#
##------------------------------------
## timer_adjust_rscat_data.pl
##------------------------------------
##

print "\n\n -------------------------------------------------------\n";
print " END PERL SCRIPT: -rscat_knmi_adjust_satfocus_data.pl-  \n";
print " --------------------------------------------------------\n";
#
#
